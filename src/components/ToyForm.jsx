  ...
  handleSubmit = (e) => {
    ...
    const newToy = {
      ...
      //image: this.state.image
            //spread operator is copying the insides of the new object, of the state passed by both image and name
            //could also use this.state in the newTodo if we didnt need to set a dafault value for 
      ...this.state, 
      likes: 0
    }
